...
public class BlockManager
{
	 ...
	 * For atomicity
	 */
	private static Semaphore mutex = new Semaphore(1); // Declared semaphore
	...
	static class AcquireBlock extends BaseThread
	{
		...
		public void run()
		{
			...
			finally // Add finally case to release the mutex
			{
				mutex.V();
			}
